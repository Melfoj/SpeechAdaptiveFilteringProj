...
figure, subplot(2,4,1), mmpolar(teta, NIVO(1,:),'RLimit',[0 -20]),hold on
subplot(2,4,2), mmpolar(teta, NIVO(2,:),'RLimit',[0 -20] ),hold on
subplot(2,4,3), mmpolar(teta, NIVO(3,:),'RLimit',[0 -20]),hold on
subplot(2,4,4), mmpolar(teta, NIVO(4,:), 'RLimit',[0 -20]),hold on
subplot(2,4,5), mmpolar(teta, NIVO(5,:), 'RLimit',[0 -20]), hold on
subplot(2,4,6), mmpolar(teta, NIVO(6,:), 'RLimit',[0 -20]),hold on
subplot(2,4,7), mmpolar(teta, NIVO(7,:), 'RLimit',[0 -20]),hold on
subplot(2,4,8), mmpolar(teta, NIVO(8,:), 'RLimit',[0 -20])
